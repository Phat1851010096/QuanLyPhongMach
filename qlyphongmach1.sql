...
INSERT INTO `lichkham` VALUES (1,'lịch khám 1',5,1,NULL,'2020-10-07',1),(3,'lịch khám 3',5,2,NULL,'2020-11-09',2),(5,'lịch khám 5',8,3,NULL,'2020-10-10',3),(6,'lịch khám 6',5,1,NULL,'2021-01-01',4),(7,'lịch khám 7',4,5,NULL,'2021-03-07',5),(8,'lịch khám 8',8,2,NULL,'2021-05-07',6),(9,'lịch khám 9',10,7,NULL,'2021-08-10',1),(10,'lịch khám 10',4,8,NULL,'2021-09-07',2),(11,'lịch khám 11',3,9,NULL,'2021-10-01',3),(12,'lịch khám 12',3,10,NULL,'2021-10-15',4);
...
CREATE TABLE `user` (
  ...
  KEY `fk_user_lichkham_idx` (`idLK`),
  CONSTRAINT `fk_user_benhnhan` FOREIGN KEY (`idBN`) REFERENCES `benhnhan` (`idBN`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_user_lichkham` FOREIGN KEY (`idLK`) REFERENCES `lichkham` (`idLK`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `user` VALUES (1,'phat','$2a$10$XRKNumkYjBM5f/YEMLpwx.wNd1FF8ljMlOfGM8R6al6b5NI1cu3jm',_binary '','ROLE_ADMIN',NULL,NULL,NULL,NULL),(6,'hieu','$2a$10$n5zGfBuuZOrHagZwQNPSGekswiL8o9NRFkdrUgL2z59zDYhMn1BR.',_binary '','ROLE_ADMIN',NULL,NULL,NULL,NULL),(8,'thien','$2a$10$mEtvSICbKTHS0FunwgIi8uqNvtGd/ae38FnfYatPom3Z0THwoniHy',_binary '\0','ROLE_BACSY','https://res.cloudinary.com/djfijumdi/image/upload/v1634043444/rsxax2hho1sdctf4wexh.png',NULL,3,NULL),(9,'do','$2a$10$QbFHRfqsZrGmvy0XR6Np8e1N5IOy11jL4cuTidfTcGMS/Evszyeeq',_binary '\0','ROLE_BACSY','https://res.cloudinary.com/djfijumdi/image/upload/v1634043458/gqjyvchappiirlltmo71.png',NULL,4,NULL),(10,'yen','$2a$10$u5DKwl/LMwFw2YfOhe/cRu8oufwMlh06R.uccF.5dk/0wZcGcD5qW',_binary '\0','ROLE_YTA','https://res.cloudinary.com/djfijumdi/image/upload/v1634043472/kmbmpjwaddi0neyzstoh.png',NULL,5,NULL),(15,'cao','$2a$10$zNbvQKz/FPWKIs4b7jw2M.2EdnzRB3KM/AoO6UfUueGsGY06ZF4pW',NULL,'ROLE_YTA','https://res.cloudinary.com/djfijumdi/image/upload/v1634093463/ny9s5pmgvbthdlueup6i.png',NULL,8,NULL),(16,'a','$2a$10$ZWDRr7lZAcoAN6jn0BJHkOrUQ6zlCXTgIwtjzoVOvMJnZRHjQl7du',NULL,'ROLE_BACSY','https://res.cloudinary.com/djfijumdi/image/upload/v1634093474/wqjqee8aywnckfehqcah.png',NULL,10,NULL),(17,'ngan','$2a$10$8LPc.NRKFxCZYTBJwPutDuxY5BlX3berAPlNoqlD8zYa1y/.0xFBK',NULL,'ROLE_USER','https://res.cloudinary.com/djfijumdi/image/upload/v1634870906/zxgryztno4homqak9com.png',10,NULL,NULL),(18,'kim','$2a$10$mpDON.NMvKjlJHnAgVP5EOqjZ9SoyUg4G35PuL1ytrFl/hGaZQvqu',NULL,'ROLE_USER','https://res.cloudinary.com/djfijumdi/image/upload/v1634871098/tv48b2qj5dq5cddxhogg.png',NULL,NULL,NULL),(19,'tham','$2a$10$SQ3Xptu9ESYb0ymfV1rvkeo2AIxsir4xyz5WczUCE4Rk7ewSuoJpC',_binary '','ROLE_USER','https://res.cloudinary.com/djfijumdi/image/upload/v1635083752/m1cqapq3fzvfiesagidj.png',1,NULL,1),(20,'nguyen','$2a$10$wzZ1A70z0bgPzTD9hUee1eDcWGo/uKnzFzaKcv/JZOv3HiTfTXb2W',NULL,'ROLE_USER','https://res.cloudinary.com/djfijumdi/image/upload/v1635086512/gahp8oedwqdbzigs6lum.png',2,NULL,3),(21,'ngu','$2a$10$Rzv6WMa9XSjNBGkF0PkS/.9zBevka2gGbfl9lF2f59WPLwP7l6W0e',NULL,'ROLE_USER','https://res.cloudinary.com/djfijumdi/image/upload/v1635383312/slis7k9mhnigogyjomav.png',3,NULL,NULL);
...
-- Dump completed on 2021-11-01  8:08:12
